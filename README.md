...
Εφέτος, η ομάδα ρομποτικής **@robo7gymchai** του σχολείου μας, αποτελείται από τον μαθητή της πρώτης τάξης _Μουτζουρίδη Βασίλη_, τη μαθήτρια της δεύτερης τάξης _Λυμπερίου Θεοδώρα_ και τον καθηγητή πληροφορικής _Μαχαιρίδη Τάσο_.
